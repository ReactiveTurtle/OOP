...
fc EmptyArgs.txt "%TEMP%\output.txt" > nul || goto err
echo Test 3 passed
...
%MyProgram% 16 (%MaxInt% + 1) 543210 > "%TEMP%\output.txt" || goto err
fc Error.txt "%TEMP%\output.txt" > nul || goto err
echo Test 13 passed

%MyProgram% 16 (%MinInt% - 1) 543210 > "%TEMP%\output.txt" || goto err
fc Error.txt "%TEMP%\output.txt" > nul || goto err
echo Test 14 passed
